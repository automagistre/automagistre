    ...
    if (!this.enableEventPropagation_) {
      ...
      for (i = 0; i < events.length; i++) {
        ...
        this.eventListeners_.push(
            google.maps.event.addDomListener(this.div_, events[i],
                cancelHandler));
      }
...
InfoBox.prototype.addClickHandler_ = function() {
  ...
  if (this.closeBoxURL_ !== '') {
    ...
    this.closeListener_ = google.maps.event.addDomListener(closeBox, 'click',
  ...
  if (!disablePan) {
    ...
    if (map instanceof google.maps.Map) { // Only pan if attached to map, not panorama
      ...
      var pixPosition = this.getProjection().
          fromLatLngToContainerPixel(this.position_);
