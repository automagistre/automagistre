...
import VehicleBodyReferenceInput from '../vehicle_body/VehicleBodyReferenceInput'
import VehicleBodyTypeReferenceInput from '../vehicle_body_type/VehicleBodyTypeReferenceInput'
