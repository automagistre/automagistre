...
final class Version20190109202038 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operand_note (id INT AUTO_INCREMENT NOT NULL, operand_id INT DEFAULT NULL, created_by_id INT NOT NULL, type SMALLINT NOT NULL COMMENT \'(DC2Type:note_type_enum)\', text LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_36BDE44118D7F226 (operand_id), INDEX IDX_36BDE441B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, car_model_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, engine_type SMALLINT NOT NULL COMMENT \'(DC2Type:engine_type)\', engine_capacity VARCHAR(255) DEFAULT NULL, transmission SMALLINT NOT NULL COMMENT \'(DC2Type:car_transmission)\', wheel_drive SMALLINT NOT NULL COMMENT \'(DC2Type:car_wheel_drive)\', vin VARCHAR(17) DEFAULT NULL, year INT DEFAULT NULL, case_type SMALLINT NOT NULL COMMENT \'(DC2Type:carcase_enum)\', gosnomer VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, mileage INT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_773DE69DB1085141 (vin), UNIQUE INDEX UNIQ_773DE69DD17F50A6 (uuid), INDEX IDX_773DE69DF64382E3 (car_model_id), INDEX IDX_773DE69D7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
