...
final class Version20180909181521 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car ADD engine_type SMALLINT NOT NULL COMMENT \'(DC2Type:engine_type_enum)\', ADD engine_capacity INT DEFAULT NULL, ADD transmission SMALLINT NOT NULL COMMENT \'(DC2Type:car_transmission_enum)\', ADD wheel_drive SMALLINT NOT NULL COMMENT \'(DC2Type:car_wheel_drive_enum)\', DROP car_modification_id, DROP sprite_id');
        $this->addSql('ALTER TABLE car_model ADD localized_name VARCHAR(255) DEFAULT NULL, ADD case_name VARCHAR(255) DEFAULT NULL, ADD case_type SMALLINT NOT NULL COMMENT \'(DC2Type:carcase_enum)\', ADD year_from SMALLINT DEFAULT NULL, ADD year_till SMALLINT DEFAULT NULL, CHANGE name name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car_modification (id INT AUTO_INCREMENT NOT NULL, car_generation_id INT NOT NULL, name VARCHAR(30) DEFAULT NULL COLLATE utf8_unicode_ci, hp SMALLINT DEFAULT NULL, doors SMALLINT DEFAULT NULL, `from` SMALLINT DEFAULT NULL, till SMALLINT DEFAULT NULL, maxspeed VARCHAR(20) DEFAULT NULL COLLATE utf8_unicode_ci, s0to100 VARCHAR(20) DEFAULT NULL COLLATE utf8_unicode_ci, tank SMALLINT DEFAULT NULL, `case` SMALLINT DEFAULT NULL COMMENT \'(DC2Type:carcase_enum)\', engine VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, transmission SMALLINT DEFAULT NULL COMMENT \'(DC2Type:car_transmission_enum)\', wheel_drive SMALLINT DEFAULT NULL COMMENT \'(DC2Type:car_wheel_drive_enum)\', INDEX IDX_B6BD9A3AFBB2DD31 (car_generation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE car ADD sprite_id INT DEFAULT NULL, DROP engine_type_enum, DROP transmission, DROP wheel_drive, CHANGE engine_capacity car_modification_id INT DEFAULT NULL');
