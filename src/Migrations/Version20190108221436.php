 ...
 */
final class Version20190108221436 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_note (id INT AUTO_INCREMENT NOT NULL, order_id INT DEFAULT NULL, type SMALLINT NOT NULL COMMENT \'(DC2Type:note_type)\', text LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_by_uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', INDEX IDX_824CC0038D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
