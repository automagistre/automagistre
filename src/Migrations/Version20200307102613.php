 ...
 */
final class Version20200307102613 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQUE_IDX ON part_case (part_id, car_model_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQUE_IDX ON balance (operand_id, tenant)');
        ...
        $this->addSql('CREATE INDEX SEARCH_IDX ON stockpile (part_id, tenant, quantity)');
        $this->addSql('CREATE UNIQUE INDEX PART_TENANT_UNIQUE_IDX ON stockpile (part_id, tenant)');
        ...
        $this->addSql('CREATE UNIQUE INDEX MANUFACTURER_CASE_IDX ON car_model (manufacturer_id, case_name)');
