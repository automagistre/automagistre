...
class Version20170427095658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item_part (id INT NOT NULL, part_id INT DEFAULT NULL, selector_id INT DEFAULT NULL, quantity INT NOT NULL, price INT NOT NULL, INDEX IDX_3DB84FC54CE34BEC (part_id), INDEX IDX_3DB84FC5706C1B43 (selector_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_part (id INT AUTO_INCREMENT NOT NULL, part_id INT DEFAULT NULL, selector_id INT DEFAULT NULL, order_id INT DEFAULT NULL, order_service_id INT DEFAULT NULL, quantity INT NOT NULL, cost INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_4FE4AD18D9F6D38 (order_id), INDEX IDX_4FE4AD14CE34BEC (part_id), INDEX IDX_4FE4AD15E8654B3 (order_service_id), INDEX IDX_4FE4AD1706C1B43 (selector_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
