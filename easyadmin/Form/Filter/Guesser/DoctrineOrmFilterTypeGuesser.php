    ...
    public function guessType($class, $property)
    {
        ...
        if ($metadata->hasAssociation($property)) {
            ...
            if ($metadata->isSingleValuedAssociation($property)) {
                ...
                $numberOfRequiredJoinColumns = count(array_filter($mapping['joinColumns'], function (
                    array $joinColumnMapping,
                ): bool {
        ...
        switch ($metadata->getTypeOfField($property)) {
            ...
            case Type::DATEINTERVAL:
                return new TypeGuess(ComparisonFilterType::class, self::$defaultOptions + [
            ...
            case Type::DATE_IMMUTABLE:
                return new TypeGuess(DateTimeFilterType::class, self::$defaultOptions + [
                    'value_type' => DateType::class,
                    'value_type_options' => ['input' => 'datetime_immutable'],
                ], Guess::HIGH_CONFIDENCE);
            case Type::TIME:
