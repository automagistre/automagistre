...
trait AdminControllerTrait
{
    ...
    /** @var null|EntityManager The Doctrine entity manager for the current entity */
    protected $em;
    ...
    public function indexAction(Request $request)
    {
        ...
        if (in_array($action, ['show', 'edit', 'new'], true)) {
    ...
    protected function listAction()
    {
        ...
        $paginator = $this->findAll($this->entity['class'], $this->request->query->getInt('page', 1), $this->entity['list']['max_results'], $this->request->query->get('sortField'), $this->request->query->get('sortDirection'), $this->entity['list']['dql_filter']);
    ...
    protected function findBy(
        ...
        if (empty($sortDirection) || !in_array(strtoupper($sortDirection), ['ASC', 'DESC'], true)) {
            $sortDirection = 'DESC';
        }
    ...
    protected function redirectToReferrer()
    {
        ...
        if (in_array($refererAction, ['new', 'edit'], true) && $this->isActionAllowed('edit')) {
            return $this->redirectToRoute('easyadmin', [
                'action' => 'edit',
                'entity' => $this->entity['name'],
                'menuIndex' => $this->request->query->get('menuIndex'),
